...
//        }
    ...
    public void shouldReturnCountryHavemostExpensiveAndActiveLaunches(int j, int k) {
        ...
        List<Rocket> topkListTest= new ArrayList<Rocket>();
        ...
        Map<Rocket, Integer> sortedRocketMap = RocketMap.entrySet().stream()
                ...
                .collect(toMap(Map.Entry::getKey, Map.Entry::getValue,
                        (oldValue, newValue) -> oldValue, LinkedHashMap::new));
        for (Rocket r: sortedRocketMap.keySet()){
            System.out.println(r.getName()+"    "+r.getCountry()+"  "+sortedRocketMap.get(r));
        }
        ...
        for (Rocket r : mostExpensiveActiveRocket){
            System.out.println(r.getName()+"    "+r.getCountry());
        }
        for (Rocket r : topkListTest){
            System.out.println(r.getName()+"    "+r.getCountry());
        }
